...
function Plant( originX ) {
  ...
  //settings
  this.fgr = gravity * Tool.rfb(5,7);  // forward growth rate (rate of cross spans increase per frame)
  this.ogr = this.fgr * Tool.rfb(0.45,0.55);  // outward growth rate (rate forward span widens per frame)
  this.msw = Tool.rfb(15,20);//18,22);  // maximum segment width, in pixels
  this.mts = Tool.rib(15,25);  // maximum total number of segments
  //base segment
